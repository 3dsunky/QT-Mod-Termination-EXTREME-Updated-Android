...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		if (PlayState.SONG.song.toLowerCase() == "extermination") //Scuffed code but whatever.
			levelDifficulty.text += "EXTREME";
		else if (PlayState.SONG.song.toLowerCase() == "cessation")
			levelDifficulty.text += "HARD?";
		else if (PlayState.SONG.song.toLowerCase() == "censory-superload")
